...
import { calcExpiry, formatUri, generateRandomBytes32, parseUri, parseExpirerTarget, createDelayedPromise, ERROR, engineEvent, isValidNamespaces, isValidRelays, isValidUrl, isValidId, isValidParams, isValidString, isValidErrorReason, isValidNamespacesChainId, isValidNamespacesRequest, isValidNamespacesEvent, isValidRequest, isValidEvent, isValidResponse, isValidRequiredNamespaces, isSessionCompatible, isExpired, isUndefined, isValidNamespacesChange, } from "@walletconnect/utils";
export class Engine extends IEngine {
    constructor(client) {
        ...
        this.connect = async (params) => {
            ...
            await this.setProposal(id, Object.assign({ id, expiry }, proposal));
            return { uri, approval };
        };
        ...
        this.setProposal = async (id, proposal) => {
